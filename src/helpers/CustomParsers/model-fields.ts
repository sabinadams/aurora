        ...
        field.attributesFixed = field.attributes.map((attribute) => {
          ...
          if (attribute.indexOf('fields:') > -1) {
            attributeObject.fields = attribute
              ...
              .split(',');
            attribute = attribute
              .replace(`fields: [${attributeObject.fields.join(', ')}]`, '')
              .split(',')
          ...
          if (attribute.indexOf('references:') > -1) {
            attributeObject.references = attribute
              ...
              .split(',');
            attribute = attribute
              .replace(`references: [${attributeObject.references.join(', ')}]`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (attribute.indexOf('name:') > -1) {
            ...
            attribute = attribute
              .replace(`name:"${attributeObject.name}"`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (attribute.indexOf('map:') > -1) {
            ...
            attribute = attribute
              .replace(`map:"${attributeObject.map}"`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (attribute.indexOf('length:') > -1) {
            ...
            attribute = attribute
              .replace(`length: ${attributeObject.length}`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (attribute.indexOf('sort:') > -1) {
            ...
            attribute = attribute
              .replace(`sort: ${attributeObject.sort}`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (attribute.indexOf('onUpdate:') > -1) {
            ...
            attribute = attribute
              .replace(`onUpdate: ${attributeObject.onUpdate}`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (attribute.indexOf('onDelete:') > -1) {
            ...
            attribute = attribute
              .replace(`onDelete: ${attributeObject.onDelete}`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (attribute.indexOf('value:') > -1) {
            ...
            attribute = attribute
              .replace(`value:${attributeObject.value}`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (
            attributeObject.attributeType !== '@default' &&
            attribute.indexOf('(') > -1 &&
            attribute.split('(')[1].charAt(0) == '"'
          ) {
            attributeObject.name = attribute.split('("')[1].split('")')[0];
            attribute = attribute
              .replace(`${attributeObject.attributeType}("${attributeObject.name}")`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
          ...
          if (attributeObject.attributeType === '@default' && !attributeObject.default) {
            ...
            attribute = attribute
              .replace(`@default(${attributeObject.default})`, '')
              .split(',')
              .map((chunk) => chunk.trim())
              .join('');
          }
