...
describe('Renderer Functions', function () {
    ...
    describe('renderModels()', function () {
        ...
        it('should render an @@index', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [baseField], indexes: [
                        {
                            name: 'test',
                            fields: ['id', 'firstName']
                        }
        ...
        it('should render a field', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [baseField] })
            ]);
            expect(modelString).toContain('id Int');
        });
        it('should render a field mapping', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { columnName: 'something' })
                    ] })
            ]);
        ...
        it('should signify an optional field', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { isRequired: false })
                    ] })
            ]);
            expect(modelString).toContain('id Int?');
        });
        it('should signify a list field', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { isList: true })
                    ] })
            ]);
            expect(modelString).toContain('id Int[]');
        });
        it('should signify an id field', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { isId: true })
                    ] })
            ]);
        ...
        it('should signify an unique field', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { isUnique: true })
                    ] })
            ]);
        ...
        it('should signify an updatedAt field', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { isUpdatedAt: true })
                    ] })
            ]);
        ...
        it('should generate a table field name mapping where', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { columnName: 'TestUpdated' })
                    ] })
            ]);
        ...
        it('should generate a table field with default numeric value', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { hasDefaultValue: true, default: 0 })
                    ] })
            ]);
        ...
        it('should generate a table field with quoted default value if non-number', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { hasDefaultValue: true, default: 'test' })
                    ] })
            ]);
        ...
        it('should generate a table field default as a function with params if an object provided', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { hasDefaultValue: true, default: {
                                name: 'autoincrement',
                                args: ['2']
                            } })
                    ] })
        ...
        it('should generate a table field relation with to/from attributes if provided', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { relationName: 'PostToUser' })
                    ] })
            ]);
        ...
        it('should generate a table field relation with just a name if provided', function () {
            var modelString = (0, renderer_1.renderModels)([
                __assign(__assign({}, baseModel), { fields: [
                        __assign(__assign({}, baseField), { relationName: 'PostToUser', relationFromFields: [], relationToFields: [] })
                    ] })
            ]);
        ...
        it('should be able to generate multiple models', function () {
            var modelString = (0, renderer_1.renderModels)([
                baseModel,
                __assign(__assign({}, baseModel), { name: 'Second' })
            ]);
            expect(modelString).toContain('model Tester');
        ...
        it('should be able to generate multiple fields', function () {
            var modelString = (0, renderer_1.renderModels)([
                ...
                __assign(__assign({}, baseModel), { fields: [
                        baseField,
                        __assign(__assign({}, baseField), { name: 'otherId' })
                    ] })
            ]);
            expect(modelString).toContain('id Int');
