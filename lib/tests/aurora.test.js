...
describe('aurora()', function () {
    ...
    describe('Generator Blocks', function () {
        ...
        it('Should filter out duplicate generators', function () { return __awaiter(void 0, void 0, void 0, function () {
            var generatedSchema, count;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getGeneratedSchema([
                    ...
                    case 1:
                        generatedSchema = _a.sent();
                        count = (generatedSchema.match(/generator client {/g) || []).length;
                        expect(count).toBe(1);
                        return [2 /*return*/];
                }
            });
    ...
    describe('Enum Blocks', function () {
        ...
        it('should render one combined enum', function () { return __awaiter(void 0, void 0, void 0, function () {
            var generatedSchema;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getGeneratedSchema([
