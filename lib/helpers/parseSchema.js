    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4, readFile(path_1.default.join(process.cwd(), filePath), { encoding: 'utf-8' })];
                case 1:
                    datamodel = _a.sent();
                    return [4, (0, sdk_1.formatSchema)({ schema: datamodel })];
                case 2:
                    datamodel = _a.sent();
                    return [4, (0, sdk_1.getDMMF)({ datamodel: datamodel })];
                case 3:
                    dmmf = _a.sent();
                    return [4, (0, sdk_1.getConfig)({ datamodel: datamodel })];
                case 4:
                    config = _a.sent();
