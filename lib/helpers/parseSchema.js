...
var getModelFieldMappings_1 = __importDefault(require("./getModelFieldMappings"));
var getModelFieldIndexes_1 = __importDefault(require("./getModelFieldIndexes"));
...
function parseSchema(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var datamodel, dmmf, config, modelMappedFields_1, indexes_1, models, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    config = _a.sent();
                    modelMappedFields_1 = (0, getModelFieldMappings_1.default)(datamodel);
                    indexes_1 = (0, getModelFieldIndexes_1.default)(datamodel);
                    models = dmmf.datamodel.models.map(function (model) {
                        model.fields = model.fields.map(function (field) {
                            if (modelMappedFields_1[model.name][field.name])
                                field.columnName = modelMappedFields_1[model.name][field.name];
                            return field;
                        });
                        model.indexes = indexes_1[model.name];
                        return model;
                    });
                    return [2 /*return*/, {
                            models: models,
