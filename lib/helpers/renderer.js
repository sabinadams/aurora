...
function renderGenerators(generators) {
    return generators
        ...
        return renderBlock('generator', generator.name, [
            ...
            renderAttribute('output', ((_a = generator === null || generator === void 0 ? void 0 : generator.output) === null || _a === void 0 ? void 0 : _a.fromEnvVar) ? generator.output.fromEnvVar : (_b = generator === null || generator === void 0 ? void 0 : generator.output) === null || _b === void 0 ? void 0 : _b.value, { env: ((_c = generator === null || generator === void 0 ? void 0 : generator.output) === null || _c === void 0 ? void 0 : _c.fromEnvVar) ? true : false, quotes: true }),
...
function renderModels(models) {
    ...
    return models
        ...
        // Indexes
        if (model.indexes)
            items.push.apply(items, model.indexes.map(renderIndex));
