    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, readFile(path_1.default.join(process.cwd(), CONSTANTS_1.CONFIG_FILE_NAME), {
                            encoding: 'utf-8'
                        })];
                case 1:
                    jsonString = _a.sent();
                    ...
                    return [2 /*return*/, (0, expandGlobPatterns_1.expandGlobPatterns)(config)];
                case 2:
                    e_1 = _a.sent();
...
var validateConfigurationObject = function (config) {
    ...
    if (config.files.filter(function (file) { return !file.endsWith('.prisma'); }).length) {
